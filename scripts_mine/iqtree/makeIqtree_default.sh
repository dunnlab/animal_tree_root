...
do
	...
	mafft-linsi /proj/metazoa_phylo/private/animal_tree_root_fork/files_mine/fasta/$line.fasta > /proj/metazoa_phylo/private/animal_tree_root_fork/files_mine/mafft/test/$line/$line.mafft
        iqtree -s /proj/metazoa_phylo/private/animal_tree_root_fork/files_mine/mafft/test/$line/$line.mafft -nt $thread -bb 1000 -pre  /proj/metazoa_phylo/private/animal_tree_root_fork/files_mine/mafft/test/$line/DEFAULT_$line ;
