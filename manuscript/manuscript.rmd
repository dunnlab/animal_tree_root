...
D=clade_rects(sequence_matrices[[1]])
...
partition_map_global %<>% left_join( partition_to_busco_map, by=c("manuscript", "matrix", "partition") )
...
matrix_overlap = 
	lapply(sequence_matrices, function(x) lapply(sequence_matrices, function(y) matrix_overlap(x,y))) %>% 
